...
export const Route = createFileRoute("/")({
  head: () => ({
    meta: [
      ...
      { name: "description", content: "All-in-one industrial batch coder. 600 DPI, 25.4mm print height, 60 m/min. Print dates, logos, barcodes on any surface. Sold by Gavalter Industrial Supplies, Uganda." },
          ...
          <div className="grid lg:grid-cols-2 gap-12 items-center">
            <div className="text-white">
              ...
              <div className="mt-8 flex flex-wrap gap-3">
                ...
                <a href="https://wa.me/256700123456" target="_blank" rel="noreferrer" className="inline-flex items-center gap-2 rounded-md border border-white/30 px-7 py-3.5 text-base font-semibold text-white hover:bg-white hover:text-navy transition">
                  WhatsApp Sales
                </a>
              </div>
        ...
        <div className="mx-auto max-w-7xl container-px grid lg:grid-cols-2 gap-12 items-center">
          <div className="reveal">
            ...
            <p className="mt-5 text-muted-foreground leading-relaxed">
              Gavalter Industrial Supplies Ltd is a Kampala-based supplier serving manufacturers, contractors, and logistics operators across Uganda and East Africa. We focus on best-in-class industrial coding and marking equipment, backed by genuine consumables and responsive local support.
            </p>
        ...
        <div className="mx-auto max-w-7xl container-px">
          <div className="rounded-3xl bg-gradient-accent p-10 md:p-14 text-center text-white shadow-accent">
            ...
            <div className="mt-6 flex flex-wrap gap-3 justify-center">
              ...
              <a href="https://wa.me/256700123456" target="_blank" rel="noreferrer" className="inline-flex rounded-md border border-white/40 px-7 py-3 font-semibold text-white hover:bg-white/10 transition">WhatsApp Now</a>
            </div>
          </div>
        </div>
      </section>
